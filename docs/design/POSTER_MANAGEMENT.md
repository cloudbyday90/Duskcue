...
- **No schema change:** Phase 2 already added `artwork.is_locked` and `artwork.source_type`; Task 9 only adds `20260625080000_seed_asset_directory_scan_task.sql` for existing deployments.
