...
| Phase 14: Platform Migration | **In progress** (Tasks 0-12 complete: scaffold, hardening, API foundation, source security, preflight, async runner, Jellyfin/Emby + Plex extraction, user mapping, matching, manual review, import merge, rollback) | — |
