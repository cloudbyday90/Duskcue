...
| Phase 16b | **In progress** (Tasks 0-6 complete: official-source TV/console platform research refreshed; TV domain shell, content IDs, authenticated feed, private cache/ETag semantics, shared TV access scope, BOLA-safe direct resolve behavior, deterministic TV surface ranking, admin diagnostics, bounded availability details, and TV surface metrics added) | — |
