...
| Phase 16b | **In progress** (Tasks 0-3 complete: official-source TV/console platform research refreshed; TV server domain shell, DTOs, validation, routes, stable error mappings, platform content ID utilities, inverse lookup, access-status reporting, and the authenticated TV surface feed with private cache/ETag semantics added) | — |
