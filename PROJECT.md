...
| Phase 11: Analytics & Trakt | **In Progress** (Tasks 1–7: analytics + dashboard + trakt scaffolding + trakt OAuth + trakt sync engine + trakt sync worker + GeoIP service; Tasks 8–9 pending: impossible travel detection + geoip updater worker) | — |
