...
| Phase 16d | **In progress** (Task 0 complete: official platform-readiness research and [CLIENT_PLATFORM_READINESS.md](docs/design/CLIENT_PLATFORM_READINESS.md) created; mandatory/advisory gates for Phases 17-23 defined; contract-source decision is curated manifest plus checked-in fixtures first, with generated OpenAPI/JSON Schema/bindings as the target direction once the server emits schemas.) | — |
