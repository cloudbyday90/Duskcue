...
| Phase 11: Analytics & Trakt | **In Progress** (Tasks 1–6: analytics + dashboard + trakt scaffolding + trakt OAuth + trakt bidirectional sync engine + trakt sync worker; Tasks 7–9 pending: GeoIP + impossible travel) | — |
