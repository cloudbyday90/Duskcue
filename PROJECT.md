...
| Phase 16b | **In progress** (Task 0 complete: official-source TV/console platform research refreshed; server-owned TV surface feed + deep-link resolver + adapter-contract approach confirmed) | — |
