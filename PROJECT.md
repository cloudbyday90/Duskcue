...
| Phase 16b | **In progress** (Tasks 0-4 complete: official-source TV/console platform research refreshed; TV domain shell, content IDs, authenticated feed, private cache/ETag semantics, shared TV access scope, and BOLA-safe direct resolve behavior added) | — |
