...
| Pre-v1.0 Hardening | **In progress** (Tasks 1-2 complete: Cache-Control + ETag response headers; Paraglide JS adoption + English web message catalog) | — |
