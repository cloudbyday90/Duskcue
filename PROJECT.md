...
| Offline Downloads | In progress (schema complete) | `download_jobs`, `download_packages`, `download_package_files`, `download_device_state`, `download_events` | [OFFLINE_DOWNLOADS.md](docs/design/OFFLINE_DOWNLOADS.md), [DATABASE.md](docs/design/DATABASE.md) |
