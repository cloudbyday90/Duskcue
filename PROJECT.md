...
| Pre-v1.0 Hardening | **In progress** (Tasks 1-5 complete: Cache-Control + ETag response headers; Paraglide JS adoption + English web message catalog; faceted search API/UI; Prometheus metrics for SSE/search/images/notifications; AI-initial preview translations for 7 non-English locales) | — |
