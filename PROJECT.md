...
| Phase 16b | **In progress** (Tasks 0-1 complete: official-source TV/console platform research refreshed; server-owned TV surface feed + deep-link resolver + adapter-contract approach confirmed; TV server domain shell, DTOs, validation, routes, and stable error mappings added) | — |
