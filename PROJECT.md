...
| Phase 16b | **In progress** (Tasks 0-5 complete: official-source TV/console platform research refreshed; TV domain shell, content IDs, authenticated feed, private cache/ETag semantics, shared TV access scope, BOLA-safe direct resolve behavior, and deterministic TV surface ranking added) | — |
