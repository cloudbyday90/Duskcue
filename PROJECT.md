...
| Phase 16a | **In progress** (Tasks 0-11 complete: official-source research/design enrichment; Tauri desktop scaffold repaired; Flutter Android/iOS scaffold created; client contracts + typed errors defined; server selection/onboarding implemented; secure auth/session lifecycle foundations implemented; desktop wrapper tray/deep-link/dialog/native-notification layer implemented; Flutter mobile shell/navigation/browsing surface implemented; mobile playback MVP implemented; foreground mobile SSE/realtime updates implemented; mobile push registration + FCM/APNs/UnifiedPush dispatch implemented; mobile quality profile/probe/QoE reporting + quality picker implemented; mobile account/settings hub implemented) | — |
