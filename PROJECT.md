...
| Phase 12: Kometa-Like System | **In progress** (Task 1: overlays domain scaffolding; Task 2: compositing pipeline — `services/overlays.rs` with `ab_glyph` + `resvg`, `preview_overlay` endpoint working, 60 tests) | — |
