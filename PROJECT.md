...
| Pre-v1.0 Hardening | **In progress** (Tasks 1-4 complete: Cache-Control + ETag response headers; Paraglide JS adoption + English web message catalog; faceted search API/UI; Prometheus metrics for SSE/search/images/notifications) | — |
