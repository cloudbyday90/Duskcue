...
| Phase 13a: System Operations Core | **In progress** (Tasks 2-7 complete; Task 10 admin UI slice complete for generic `server_config` JSONB editing and backup/recovery panel; Tasks 8-9 still pending) | — |
