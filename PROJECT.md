...
| Phase 16a | **In progress** (Tasks 0-5 complete: official-source research/design enrichment; Tauri desktop scaffold repaired; Flutter Android/iOS scaffold created; client contracts + typed errors defined; server selection/onboarding implemented; secure auth/session lifecycle foundations implemented; desktop wrapper tray/deep-link/dialog/native-notification layer implemented) | — |
