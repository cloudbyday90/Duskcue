...
| Phase 16b | **In progress** (Tasks 0-2 complete: official-source TV/console platform research refreshed; TV server domain shell, DTOs, validation, routes, stable error mappings, platform content ID utilities, strict encoders, URL encoders, inverse lookup, and access-status reporting added) | — |
