...
| Phase 16a | **In progress** (Tasks 0-3 complete: official-source research/design enrichment; Tauri desktop scaffold repaired; Flutter Android/iOS scaffold created; client contracts + typed errors defined; server selection/onboarding implemented) | — |
