...
class DuskcueApiClient {
  ...
  Future<Response<T>> get<T>(String path, {Map<String, Object?>? query}) {
    return _request(() => _dio.get<T>(path, queryParameters: query));
  }

  Future<Response<T>> post<T>(String path, {Object? body}) {
    return _request(() => _dio.post<T>(path, data: body));
  }

  Future<Response<T>> put<T>(String path, {Object? body}) {
    return _request(() => _dio.put<T>(path, data: body));
  }

  Future<Response<T>> patch<T>(String path, {Object? body}) {
    return _request(() => _dio.patch<T>(path, data: body));
  }
