...
<script>
    ...
    const groupSchemas = [
        ...
        },
        {
            key: 'notifications',
            title: 'Notifications',
            desc: 'Notification cleanup plus future push and webhook dispatch settings.',
            fields: [
                number('cleanup_max_age_days', 'Cleanup Max Age', 1, 3650, 1, 'days'),
                toggle('push_enabled', 'Enable Push Notifications', 'Activation requires Phase 13b - notification dispatch'),
                select('push_provider', 'Push Provider', ['webpush'], 'Activation requires Phase 13b - notification dispatch'),
