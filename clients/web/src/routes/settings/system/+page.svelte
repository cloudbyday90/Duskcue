    ...
    const groupSchemas = [
        ...
        },
        {
            ...
            fields: [
                ...
                select('push_provider', 'Push Provider', ['fcm', 'apns', 'unifiedpush'], 'Mobile push client (FCM/APNs/UnifiedPush) ships in Phase 16a'),
                text('vapid_public_key', 'VAPID Public Key', 'Mobile push client (FCM/APNs/UnifiedPush) ships in Phase 16a'),
                password('vapid_private_key', 'VAPID Private Key', 'Mobile push client (FCM/APNs/UnifiedPush) ships in Phase 16a'),
                toggle('webhook_enabled', 'Enable Webhooks', 'Posts to your webhook URL on each notification. Configure URL + format below.'),
